...
START_TEST(test_less_or_equal_positive_less) {
...
START_TEST(test_less_or_equal_positive_equal) {
...
START_TEST(test_less_or_equal_positive_greater) {
...
START_TEST(test_less_or_equal_mixed_signs) {
...
TCase *tcase_less_or_equal(void) {
  ...
  tcase_add_test(tc, test_less_or_equal_positive_less);
  tcase_add_test(tc, test_less_or_equal_positive_equal);
  tcase_add_test(tc, test_less_or_equal_positive_greater);
  tcase_add_test(tc, test_less_or_equal_negative_less);
  tcase_add_test(tc, test_less_or_equal_mixed_signs);
  return tc;
}